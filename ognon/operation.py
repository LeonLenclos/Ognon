...
class Operation():
    ...
    def __init__(self, fun, *args, **kwargs):
        ...
        # (renseignés sous la forme d'une str ou d'un tuple de deux str)
    ...
    def ask_for(self, infos):
        ...
        if type_asked == "int":
            return tkinter.simpledialog.askinteger(self.name, message)
        elif type_asked == "str":
            return tkinter.simpledialog.askstring(self.name, message)
